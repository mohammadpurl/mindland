...
import { Python03VariablesLessonView } from '@/app/components/lesson/Python03VariablesLessonView'
...
export default async function Python03VariablesPage({ params }: Props) {
  const { lang } = await params

  return (
    <main className="min-h-screen bg-[#0B1220] pb-24 md:pb-0">
      <Navbar lang={lang} />
      <Python03VariablesLessonView lang={lang} />
