...
import { Python07ForLoopLessonView } from '@/app/components/lesson/Python07ForLoopLessonView'
...
export default async function Python07ForLoopPage({ params }: Props) {
  const { lang } = await params

  return (
    <main className="min-h-screen bg-[#0B1220] pb-24 md:pb-0">
      <Navbar lang={lang} />
      <Python07ForLoopLessonView lang={lang} />
