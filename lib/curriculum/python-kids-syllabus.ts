  ...
  sections: [
    ...
    },
    {
      ...
      lessons: [
        ...
        },
        {
          ...
          goal: 'متن چاپ کند و با نقل‌قول آشنا شود',
          metaphor: 'کارت تولد دیجیتال / نامه به دوست',
          guided: 'ساخت کارت تبریک ۳–۵ خطی',
          challengeA: 'کارت تولد برای شخصیت خیالی',
          challengeB: 'کارت + تفاوت رشته و عدد',
          duration: '۴۵′',
          status: 'planned',
        },
        {
          ...
          metaphor: 'جعبه‌های اسباب‌بازی با برچسب اسم',
          guided: 'name / age و چاپ جمله با متغیر',
          challengeA: 'معرفی کوتاه با ۲ متغیر',
          challengeB: '۳+ متغیر + تغییر مقدار وسط برنامه',
          duration: '۴۵′',
          status: 'planned',
        },
        {
          ...
          metaphor: 'ماشین‌حساب جادویی',
          guided: 'محاسبهٔ ساده (پول، سن آینده)',
        ...
        },
        {
          ...
          metaphor: 'گفت‌وگو با ربات',
          guided: 'برنامهٔ حدس اسم / خوش‌آمد',
    ...
    },
    {
      ...
      lessons: [
        {
          code: 'PY-06',
          id: 'python-06-conditionals',
          title: 'شرط‌ها (if / else)',
          goal: 'یک تصمیم دوتایی درست بنویسد',
          metaphor: 'اگر باران آمد، چتر ببر',
          guided: 'امتیاز → آفرین / دوباره تلاش کن',
        ...
        },
        {
          ...
          metaphor: 'شمارش ستاره / الگوی تکراری',
          guided: 'چاپ الگو با for و range',
          challengeA: 'الگوی متنی ساده',
          challengeB: 'الگو + پیمایش کوتاه روی رشته',
          duration: '۵۰′',
          status: 'planned',
        },
        {
          ...
          metaphor: 'بازی حدس عدد',
          guided: 'حدس عدد با بازخورد بزرگ/کوچک',
          challengeA: 'حدس با محدوده کوچک و راهنمایی',
          challengeB: 'شمارش تلاش‌ها + خروج اختیاری',
          duration: '۵۰′',
          status: 'planned',
        },
      ],
